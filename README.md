...
由于 APK 安装包和编译产物不随源码上传，若您只需要使用该工具，请直接在仓库的 **[GitHub Releases](https://github.com/TuSiV/desensitization/releases)** 或 **[Codeberg Releases](https://codeberg.org/tusiv/desensitization/releases)** 页面下载适用于您系统的可执行文件：
